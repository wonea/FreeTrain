...
{
	public enum GameMode { FreeBuild, TransportCompany, LordMayor, TrafficBureau, SenarioEditor, reserved5, reserver6, reserved7 };
	...
	{		
		...
		public GameMode CurrentMode { get{ return _curMode; } }
		public IGame CurrentGame { get{ return _curGame; } }
		protected void SetGame(IGame newgame, bool prompt)
		{
			if(_curGame != null )
			{
				if( prompt )
...
//				catch(Exception e)
//				{
//					string text = Core.resources["game.game_create_error"].stringValue;
...
//			}
		...
		public bool ConfirmCloseGame() 
		{
			...
			{
				string text = Core.resources["game.close_game_warning"].stringValue;
...
//			catch( Exception e )
//			{
//				string templ = Core.resources["game.game_load_error"].stringValue;
